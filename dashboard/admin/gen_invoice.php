...
<table id =space width="760" height="397" border="0" align="center">
  <tr>
    ...
    <td height="198"><p>No de Serie : <?php echo $row['et_id'] ?></p>
      <p>&nbsp;</p>
      <p>Fecha : <?php echo $row['paid_date']?></p></td>
    </tr>
   
  <tr>
    <td height="118" colspan="3"><p>Recibida Por : <?php echo $row['username']?></p>
      <p>La suma de: $<?php echo $row['amount']?></p>
      <p>Según su Membresía: <?php echo $row['planName']?></p></td>
    </tr>
